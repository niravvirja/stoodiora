...
---
${firmData?.name || BUSINESS_DEFAULTS.FIRM_NAME}
${firmData?.description || BUSINESS_DEFAULTS.TAGLINE}
${firmData?.header_left_content || `Contact: ${BUSINESS_DEFAULTS.CONTACT_PHONE}`}
