  ...
  events: {
    ...
    filterOptions: [
      ...
      // Staff Role Filters - these query assignments table
      {
        ...
        type: 'boolean',
        queryBuilder: (query) => query.filter('event_staff_assignments.role', 'eq', 'Photographer')
      },
      {
        key: 'cinematographer',
        label: 'Has Cinematographer', 
        type: 'boolean',
        queryBuilder: (query) => query.filter('event_staff_assignments.role', 'eq', 'Cinematographer')
      },
      {
        key: 'editor',
        label: 'Has Editor',
        type: 'boolean',
        queryBuilder: (query) => query.filter('event_staff_assignments.role', 'eq', 'Editor')
      },
      {
        key: 'drone',
        label: 'Has Drone Operator',
        type: 'boolean',
        queryBuilder: (query) => query.filter('event_staff_assignments.role', 'eq', 'Drone')
      },
