  ...
  useEffect(() => {
    if (firmData && currentFirmId) {
      setBrandingData({
        ...
        contactPhone: extractPhone(firmData.header_left_content) || BUSINESS_DEFAULTS.CONTACT_PHONE,
        contactEmail: extractEmail(firmData.header_left_content) || BUSINESS_DEFAULTS.CONTACT_EMAIL,
        tagline: firmData.description || BUSINESS_DEFAULTS.TAGLINE,
        signature: BUSINESS_DEFAULTS.SIGNATURE,
        description: firmData.description || BUSINESS_DEFAULTS.TAGLINE,
        headerLeftContent: firmData.header_left_content || `Contact: ${BUSINESS_DEFAULTS.CONTACT_PHONE}\nEmail: ${BUSINESS_DEFAULTS.CONTACT_EMAIL}`,
        footerContent: firmData.footer_content || `${firmData.name || BUSINESS_DEFAULTS.FIRM_NAME} | Contact: ${BUSINESS_DEFAULTS.CONTACT_PHONE} | Email: ${BUSINESS_DEFAULTS.CONTACT_EMAIL}\n${BUSINESS_DEFAULTS.TAGLINE} | ${BUSINESS_DEFAULTS.SIGNATURE}`
      });
    }
