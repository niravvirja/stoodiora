          ...
          <div className="bg-muted/30 rounded-lg p-3 sm:p-4 space-y-2 sm:space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2 sm:gap-3 text-xs sm:text-sm">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 min-w-0">
                  <span className="text-muted-foreground flex-shrink-0">Event Date:</span>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 min-w-0">
                  <span className="text-muted-foreground flex-shrink-0">Event Type:</span>
            ...
            <div className="bg-muted/20 border border-border rounded-lg p-3 sm:p-4 space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3">
                ...
                {days.map((day: any, index: number) => (
                  <div key={day.id || index} className="rounded-lg p-3 border border-border">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
                      <h4 className="text-sm font-medium">{day.name || `Day ${index + 1}`}</h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                      <div className="flex items-center justify-between p-2 rounded border border-border">
                        ...
                        <span className="font-medium text-foreground">₹{(day.photographers * day.photographerRate).toLocaleString()}</span>
                      </div>
                      <div className="flex items-center justify-between p-2 rounded border border-border">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-muted-foreground">Cinematographers</span>
                        </div>
                        <span className="font-medium text-foreground">₹{(day.cinematographers * day.cinematographerRate).toLocaleString()}</span>
                      </div>
                      <div className="flex items-center justify-between p-2 rounded border border-border">
                        <div className="flex items-center gap-2">
                          <DroneIcon className="h-3 w-3 text-purple-500 flex-shrink-0" />
                          <span className="text-purple-500 font-medium">{day.drone}</span>
                          <span className="text-muted-foreground">Drone Operators</span>
                        </div>
                        <span className="font-medium text-foreground">₹{(day.drone * day.droneRate).toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                ))}
