...
const HomePage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Complete crew management with skill-based assignments, availability tracking, performance analytics, and automated salary calculations. Manage photographers, videographers, editors, and assistants efficiently.',
