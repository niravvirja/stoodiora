  ...
  const values = [
    {
      ...
      description: 'Empowering photographers and videographers to focus on their craft by eliminating administrative burdens.'
    },
    {
      icon: BulbIcon,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                videographers were spending more time on paperwork than on their passion. Our founder, 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Be part of a growing community of photographers and videographers who have 
