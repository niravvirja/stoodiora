        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2">
              <a href="mailto:pritphoto1985@gmail.com" className="flex items-center space-x-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <Mail01Icon className="w-4 h-4" />
                <span>pritphoto1985@gmail.com</span>
              </a>
              <a href="tel:+917285072603" className="flex items-center space-x-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <PhoneOff01Icon className="w-4 h-4" />
                <span>+91 7285072603</span>
              </a>
            </div>
          </div>
