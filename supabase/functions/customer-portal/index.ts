      ...
      availablePlans: [
        {
          ...
          price: 749,
          duration: '1 month',
          features: ['Unlimited events', 'Task management', 'Financial tracking', 'WhatsApp integration']
        },
        {
          id: 'annual',
          name: 'Annual Plan', 
          price: 8199,
          duration: '12 months',
          features: ['All Monthly features', 'Priority support', 'Advanced reporting', 'Early access to features']
        }
      ]
    };
